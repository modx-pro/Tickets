...
$_lang['subscribes'] = 'Abonnements';
$_lang['ticket_comment_reply_to'] = 'Antwort an';
$_lang['ticket_comment_update'] = 'Kommentar bearbeiten';
$_lang['ticket_comment_upload_auth'] = 'Sie müssen angemeldet sein, um Dateien hochladen zu können.';
$_lang['ticket_deleted_text'] = 'Gelöscht';
$_lang['ticket_email_subscribed_author'] = 'Der Benutzer <b>[[+fullname]]</b>, den Sie abonniert haben, hat ein neues Ticket veröffentlicht: "<a href="[[~[[+id]]?scheme=`full`]]">[[+pagetitle]]</a>" im Ticket-Bereich "<a href="[[~[[+section]]?scheme=`full`]]">[[+section_title]]</a>".';
$_lang['ticket_err_files_limit'] = 'Es können nicht mehr als [[+limit]] Dateien hochgeladen werden';
$_lang['ticket_err_wrong_author'] = 'Ungültiger Ticket-Autor angegeben.';
$_lang['ticket_undelete'] = 'Ticket wiederherstellen';
$_lang['ticket_undelete_text'] = 'Sind Sie sicher, dass Sie dieses Ticket wiederherstellen wollen?';
$_lang['ticket_undeleted_text'] = 'Wiederhergestellt.';
$_lang['tickets_action_reply'] = 'Antworten';
$_lang['tickets_action_unsubscribe'] = 'Abbestellen';
$_lang['tickets_author_email_subscription'] = 'Neues Ticket des Autors [[+user.fullname]]';
$_lang['tickets_author_notify'] = 'Über Tickets des Autors benachrichtigen';
$_lang['tickets_author_subscribed'] = 'Sie haben Benachrichtigungen über neue Tickets dieses Autors abonniert.';
$_lang['tickets_author_unsubscribed'] = 'Sie werden keine weiteren Benachrichtigungen über neue Tickets dieses Autors erhalten.';
