...
$_lang['tickets_prop_tplComment'] = 'A Chunk for the comment itself.';
$_lang['tickets_prop_tplComments'] = 'A Chunk for the outer wrapper for comments.';
$_lang['tickets_prop_tplLoginToComment'] = 'The portion to show when the user is not logged in. Can either be a chunk name or value. If set to a value, will override the chunk.';
$_lang['tickets_prop_tplCommentEmailOwner'] = 'The chunk for notification of new comments of ticket owner.';
$_lang['tickets_prop_tplCommentEmailReply'] = 'The chunk for notification of user who replied to a comment.';
