...
$_lang['tickets.useGravatar'] = 'If true, will attempt to use Gravatar images for avatars.';
...
$_lang['tickets.nameField'] = 'The field to use for the author name of each comment. Recommended values are "name" or "username".';
$_lang['tickets.tplAddComment'] = 'The add comment form. Can either be a chunk name or value. If set to a value, will override the chunk.';
