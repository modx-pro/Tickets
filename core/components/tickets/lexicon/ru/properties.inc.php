...
$_lang['tickets.useCss'] = 'Если включено - будет загружено простое оформление комментариев.';
$_lang['tickets.useJs'] = 'Если включено - будут загружены базовые скрипты комментариев';
$_lang['tickets.useGravatar'] = 'Использовать сервис хранения аватаров?';
$_lang['tickets.dateFormat'] = 'Формат даты комментария, согласно strftime()';
$_lang['tickets.gravatarIcon'] = 'Тип загружаемого аватара';
$_lang['tickets.gravatarSize'] = 'Размер загружаемого аватара';
$_lang['tickets.gravatarUrl'] = 'Адрес для загрузки аватаров';
$_lang['tickets.nameField'] = 'Поле имени автора, например username или fullname';
$_lang['tickets.tplAddComment'] = 'Чанк для формы добавления нового комментария';
