...
$_lang['tickets_prop_tplCommentFormGuest'] = 'Чанк формы добавления комментария для гостей';
...
$_lang['tickets_prop_tplTicketEmailSubscription'] = 'Чанк для уведомления подписчика секции о новом тикете.';
...
$_lang['tickets_prop_tree'] = 'Выводить комментарии деревом. Нет — плоский список (с пагинацией через limit/offset).';
$_lang['tickets_prop_separatePlaceholder'] = 'Если да, каждый комментарий сохраняется в отдельный плейсхолдер вместо общего вывода.';
