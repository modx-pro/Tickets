...
$_lang['tickets_prop_tplCommentFormGuest'] = 'Чанк форми додавання коментаря для гостей';
...
$_lang['tickets_prop_tplTicketEmailSubscription'] = 'Чанк для попередження підписника секції про новий тікет.';
...
$_lang['tickets_prop_tree'] = 'Виводити коментарі деревом. Ні — плоский список (пагінація через limit/offset).';
$_lang['tickets_prop_tplCommentEmailUnpublished'] = 'Чанк для сповіщення адмінів про неопублікований коментар.';
$_lang['tickets_prop_autoPublishGuest'] = 'Публікувати всі нові коментарі анонімних користувачів без премодерації.';
$_lang['tickets_prop_threadUrl'] = 'Абсолютний url для переходу до коментаря з адмінки. Використовується при коментуванні не ресурсів.';
$_lang['tickets_prop_allowFiles'] = 'Дозволити користувачу завантажувати файли на сервер.';
$_lang['tickets_prop_separatePlaceholder'] = 'Якщо так, кожен коментар зберігається в окремий плейсхолдер замість загального виводу.';
$_lang['tickets_prop_source'] = 'Id медіа-джерела для файлів коментаря.';
$_lang['tickets_prop_tplFiles'] = 'Чанк-обгортка для завантажувача файлів у формі коментаря.';
$_lang['tickets_prop_tplFile'] = 'Чанк для завантаженого файлу, який не є зображенням.';
$_lang['tickets_prop_tplImage'] = 'Чанк для завантаженого зображення.';
