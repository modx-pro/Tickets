<div class="section">
	...
	<div class="row">
		...
		<div class="span3"><i class="icon-user"></i> <b>[[+fullname]]</b></div>
		<div class="span1"><a href="[[~[[+id]]]]#comments"><i class="icon black icon-comment"></i> [[+comments]] [[+ticket_new_comments]]</a></div>
