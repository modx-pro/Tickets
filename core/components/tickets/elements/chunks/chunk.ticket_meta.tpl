<div class="ticket-meta row" data-id="[[+id]]">
	...
	<span class="col-md-1">[[+stared]][[+unstared]]</span>
...
<!--tickets_stared <i class="glyphicon glyphicon-star text-success"></i>-->
<!--tickets_unstared <i class="glyphicon glyphicon-star text-muted"></i>-->
