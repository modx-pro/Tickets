<form class="well create" method="post" action="" id="ticketForm">
	...
	<label for="ticket-pagetitle">
		<input type="text" class="input-xxlarge" placeholder="[[%ticket_pagetitle]]" name="pagetitle" value="" maxlength="50" id="ticket-pagetitle"/>
		<span class="error"></span>
	</label>
	...
	<div class="form-actions">
		<input type="button" class="btn" value="[[%ticket_preview]]" onclick="return Tickets.ticket.preview(this.form, this);"/>
